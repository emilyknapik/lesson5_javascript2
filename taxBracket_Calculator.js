        ...
        if (status == 0) { 
          ...
          *******************************************************************************/
                ...
                taxRate = 22;
                    ...
                    tax = 19050 * 0.10 + (7740 - 19050) * 0.12 + (165000 - 77400) * 0.22 + (31500 - 165000) * 0.24 + (400000 - 315000) * 0.32 + (income - 400000) * 0.35;
                    taxRate = 35;
                }
                else {
                    tax = 19050 * 0.10 + (77400 - 19050) * 0.12 + (165000 - 77400) * 0.22 + (315000 - 165000) * 0.24 + (400000 - 315000) * 0.32 + (600000 - 400000) * 0.35 + (income - 600000) * .37;
                    taxRate = 37;
                }
          ...
          *******************************************************************************/
                ...
                if (income <= 13600){
                    ...
                    tax = 13600 * 0.10 (51800 - 13600) * 0.12 + (82500 - 51800) * 0.22 + (157500 - 82500) * 0.24 + (200000 - 157500) * 0.32 + (500000 - 200000) * 0.35 + (income - 500000) * .37;
                    taxRate = 37
                }
